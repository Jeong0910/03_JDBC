...
public class JDBCExample5 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// 4. PreparedStatemnt 객체 생성
			// -> 객체 생성과 동시에 sql 담겨짐
			// -> 미리? ?(위치홀더)에 값을 받을 준비를 해야되기 때문에
			
			//stmt = conn.createStatment(sql);
			...
			// ptsmt에서 executeQuery(), executeUpdate()
